...
export const DEFAULT_CATEGORIES: Category[] = [
  ...
  { id: "gemeente", name: "Gemeente", color: "#3D5A80", description: "The Amsterdam municipality — bills for local taxes such as afvalstoffenheffing and OZB.", featured: true, logo: null, sortOrder: 3 },
